...
/* Predicate that returns true if the two cars are ordered correctly by years. 
 */
static
int ordered_cars(void* left, void* right)
{
  struct automobile* l = (struct automobile*) left;
  struct automobile* r = (struct automobile*) right;
...
int main() {
  ...
  sort_array((void**)data, data_size, ordered_cars);
